...
class appAppKernelProdContainer extends Container
{
    ...
    {
        return $this->privates['fragment.listener'] = new \Symfony\Component\HttpKernel\EventListener\FragmentListener(($this->privates['uri_signer'] ?? ($this->privates['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('uMVQLdfgfKx7eUqSnYakS5nI8uZoJAfOVWdjOr4sKOAeo5c8bYCwCq4yS8DDGN3S'))), '/_fragment');
    }
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'secret' => 'uMVQLdfgfKx7eUqSnYakS5nI8uZoJAfOVWdjOr4sKOAeo5c8bYCwCq4yS8DDGN3S',
            'ps_caching' => 'CacheMemcache',
            'ps_cache_enable' => false,
            'ps_creation_date' => '2024-08-21',
            'locale' => 'fr-FR',
            'use_debug_toolbar' => true,
            'cookie_key' => 'Zq1o9EpxXJ9Iu8HPGcEYL8uS5XWIqyoMJBmNC6iJB2ir8ovbxxfBJbTrF878ZwfW',
            'cookie_iv' => 'j8A8QIP12y8ZkepAAV7TwSKdhuTFRD7G',
            'new_cookie_key' => 'def00000f8145a2664fa45b37ad8850d59424c416799bb2ccf73b066b426be1fddde490397878e12691c279bcd8c0f5db1be3002f4bdd7064b9358a8ad8bda7c367048a2',
            'api_public_key' => '-----BEGIN PUBLIC KEY-----'."\n".'MIIBIjANBgkqhkiG9w0BAQEFAAOCAQ8AMIIBCgKCAQEAmBaX772NRZM19MKzE6xR'."\n".'zjAkv8IOosFrpa52w019FiIUxt8a73fBYumCR/jev4C4k89IjJKJmrkh5CRnVDj5'."\n".'SUZpNnie0B2v0RcyBCt2DCOXcY0j3QUMT9fuOIp1i9NhfFuzB1+Nv9euN636UDwY'."\n".'94LDBWhKLNCfiw/tJJGCX7PgGrG++5KLH/UNYdnLnu5RQuDRwuLH99SW87Utelo4'."\n".'AgRNCQIq8zTEM18w3lmBR/NCrt4fUOL03FlXNuQA7yFkO8A//U5k5r1S1+YzN3/Y'."\n".'cPKO11TA1OFUU1z+kH2Gl+ysV62Hy1r9KuY0kieOTgTxr0khB0hC5JRpkcEbneT+'."\n".'6QIDAQAB'."\n".'-----END PUBLIC KEY-----'."\n".'',
            'api_private_key' => '-----BEGIN PRIVATE KEY-----'."\n".'MIIEvAIBADANBgkqhkiG9w0BAQEFAASCBKYwggSiAgEAAoIBAQCYFpfvvY1FkzX0'."\n".'wrMTrFHOMCS/wg6iwWulrnbDTX0WIhTG3xrvd8Fi6YJH+N6/gLiTz0iMkomauSHk'."\n".'JGdUOPlJRmk2eJ7QHa/RFzIEK3YMI5dxjSPdBQxP1+44inWL02F8W7MHX42/1643'."\n".'rfpQPBj3gsMFaEos0J+LD+0kkYJfs+Aasb77kosf9Q1h2cue7lFC4NHC4sf31Jbz'."\n".'tS16WjgCBE0JAirzNMQzXzDeWYFH80Ku3h9Q4vTcWVc25ADvIWQ7wD/9TmTmvVLX'."\n".'5jM3f9hw8o7XVMDU4VRTXP6QfYaX7KxXrYfLWv0q5jSSJ45OBPGvSSEHSELklGmR'."\n".'wRud5P7pAgMBAAECggEAAm1p42OtG40r8UoiPZAkhhvymjTosuRPaYeNUbSs6GuG'."\n".'1V2+OlA4//EmKSvpsjjFuWY3jDbSh2upBNEn7QozwF2lVD88mam/oqCyJarj6XGv'."\n".'+xn7lo18EtIpdTGQirjG94snIlj+FC/HEhBuzFUJOPoXTsDJXkm+IiQQ7uJ7qDda'."\n".'cUi5GZMjH/19htv8tRYM7fDFfHa4KIfHfhz43nsKcmqMfCKtf2A7tqtV9E122foU'."\n".'HdyX9R0gTvXzHLJ4CD/ksrzQKytUdMNkJC+Y7KLfc2BMlOgaA21jsIUZEtxMqu0T'."\n".'g3DbTg+DIIN/ZZsJ9TBSVpmGAQ9qUbUQOAHNdLmtOQKBgQDKqn5l9S35S8uz4ysq'."\n".'LxlcxVFRwdPQ7b1WnKVlDRvMX8rvU7/wg6nFCiPpUF0dMJYsm5+g8cUWg9QdV9Qd'."\n".'cOkUIlVZ+5vD+SMr4dpO5EqaLK0xh4f5dYwmydk+Y9v0f/OK3q68dixu7GfRQ1PX'."\n".'omqgxTZYwJsLrfALrhAPlw2GBwKBgQDAHLP87dxSaNBhuwHy6v8L/OZHaUSn7Tn/'."\n".'wSp20R7d0PiInXqb1HFG5O+/E8HcJsyqZ0LxeMtJhX1gYdtV2z13GoQhPQxLvDOg'."\n".'8jHMxcv7os1ziGmti4hM4uW/NJ3FMIKRcBgQnWzrPVyiq7jmGDMml9+6bXzonw2f'."\n".'tS93GC+XjwKBgAJ4h6f4kEHs0aP0zg7qmhWOdkpX4Zw3ecp3iHCt8zvPoyq9y6ZE'."\n".'BKrZT8zFZQ05DWunzg9pQyzeGJTvADAHs1/Cd2Xscl62R95+F2pE0EAG8WmcLGU3'."\n".'MKk8ZsCi+QiHEtILmvfDPRFxImbjuj7zxPcG0H3Og1VmHnoV+i4meky7AoGAAx80'."\n".'SZLv9qLfaAcq8/CfrmkwsM5kIDp5q89OylmBn+cqcsXkXS3pnVZRExDWIKa8wrQk'."\n".'4VmuLAawT+WnM9D5Qbs7lHKyhXSMfjwRVRuNwgwWPJ9l4D0ZPO6e/ylyuuab6JMi'."\n".'wPpd78Cyha42tf6Erkbfit8GnZ0gEo1WNSA+fb8CgYBZYdavqLAFJFACfZM6Wrjc'."\n".'fEiWcaBFr97WeGuKGXjwFRLvQgx9am4vr7nfYDTMBnejZ6WMwA7QP7k5TNdLTmWR'."\n".'wcG5pRGatOe2d9bMpSQCz3pZSbPlTlTU/E4VCe2707Y8GAACYCU1H/Jx54ZKLnDv'."\n".'vnm+4AxC/KzV33rSzdb5YA=='."\n".'-----END PRIVATE KEY-----'."\n".'',
            'cache.driver' => 'array',
            ...
            'modules_translation_paths' => [
                ...
                29 => (\dirname(__DIR__, 4).'/modules/ps_viewedproduct/translations'),
                30 => (\dirname(__DIR__, 4).'/modules/ps_googleanalytics/translations'),
                ...
                36 => (\dirname(__DIR__, 4).'/modules/dashtrends/translations'),
                37 => (\dirname(__DIR__, 4).'/modules/statsbestsuppliers/translations'),
                38 => (\dirname(__DIR__, 4).'/modules/statscatalog/translations'),
                39 => (\dirname(__DIR__, 4).'/modules/statsbestmanufacturers/translations'),
                40 => (\dirname(__DIR__, 4).'/modules/pagesnotfound/translations'),
                41 => (\dirname(__DIR__, 4).'/modules/statssearch/translations'),
                42 => (\dirname(__DIR__, 4).'/modules/ps_checkpayment/translations'),
                43 => (\dirname(__DIR__, 4).'/modules/dashgoals/translations'),
                44 => (\dirname(__DIR__, 4).'/modules/statsforecast/translations'),
                45 => (\dirname(__DIR__, 4).'/modules/dashactivity/translations'),
                ...
                50 => (\dirname(__DIR__, 4).'/modules/statsregistrations/translations'),
                ...
                54 => (\dirname(__DIR__, 4).'/modules/statsbestcustomers/translations'),
                55 => (\dirname(__DIR__, 4).'/modules/ps_crossselling/translations'),
                56 => (\dirname(__DIR__, 4).'/modules/ps_categoryproducts/translations'),
                57 => (\dirname(__DIR__, 4).'/modules/gridhtml/translations'),
                58 => (\dirname(__DIR__, 4).'/modules/dashproducts/translations'),
                59 => (\dirname(__DIR__, 4).'/modules/prettyblocks/translations'),
            ],
            ...
            'kernel.secret' => 'uMVQLdfgfKx7eUqSnYakS5nI8uZoJAfOVWdjOr4sKOAeo5c8bYCwCq4yS8DDGN3S',
