...
<div class="user-info">
  {if $customer.is_logged}
    ...
    <a class="account" href="{$urls.pages.my_account}" title="{l s='View my customer account' d='Shop.Theme.Customeraccount'}" rel="nofollow"><span>{$customerName} coucou</span></a>
  {else}
